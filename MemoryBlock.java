...
public class MemoryBlock {
    ...
    /**
     * Constructs a new memory block with a given base address and length in
     * words
     *
    ...
    /**
     * A textual representation of this memory block, for debugging. The block's
     * contents appears within parentheses. For example: (208,10)
     */
